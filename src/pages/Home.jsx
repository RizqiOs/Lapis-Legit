      ...
      <section id="about" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            Lapis Legit Kedaton adalah toko kue tradisional yang berdedikasi untuk
            menghadirkan cita rasa lapis legit autentik. Setiap kue dibuat dengan
            cinta dan perhatian terhadap detail, menggunakan resep turun-temurun
