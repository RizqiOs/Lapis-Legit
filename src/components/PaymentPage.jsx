        ...
        {!isPaymentSent ? (
          <>
            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <label
                className={`border rounded-lg p-3 sm:p-4 cursor-pointer hover:bg-gray-50 transition flex items-center gap-3 ${
                  selectedMethod === "alfamart" ? "border-blue-500 bg-blue-50" : ""
                }`}
              >
                <input
                  type="radio"
                  name="paymentMethod"
                  value="alfamart"
                  checked={selectedMethod === "alfamart"}
                  onChange={() => setSelectedMethod("alfamart")}
                  className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600"
                />
                <div>
                  <strong className="text-sm sm:text-base">Alfamart / Indomaret</strong>
